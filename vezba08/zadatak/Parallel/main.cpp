...
// globals
concurrent_queue<unsigned char> in2HighPassQueue;
concurrent_queue<short> highPass2ClipQueue;
concurrent_vector<unsigned char> clip2CounterVector;
CounterTable counterValues;

int main(int argc, char* argv[]) {
    // array initialization, set memory block values to 0x00
    //memset(counterValues, 0x00, _D_ARRAY_SIZE*sizeof(unsigned int));
